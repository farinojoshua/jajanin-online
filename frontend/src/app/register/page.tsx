    ...
    const googleLogin = useGoogleLogin({
        onSuccess: async (tokenResponse: any) => {
            ...
            try {
                ...
                onError(err.response?.data?.error || 'Gagal daftar dengan Google');
            } finally {
                setIsLoading(false);
            }
        },
        onError: () => {
            onError('Daftar dengan Google gagal. Silakan coba lagi.');
        },
    });
            ...
            <div className="w-full max-w-md">
                ...
                <div className="card">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-center mb-8">
                        Daftar gratis dan mulai terima donasi
                    </p>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white dark:bg-dark-900 text-gray-500">atau daftar dengan email</span>
                        </div>
                    </div>
                    ...
                    <p className="text-center text-gray-600 dark:text-gray-400 mt-6">
                        Sudah punya akun?{' '}
                        <Link href="/login" className="text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 transition">
                            Masuk di sini
                        </Link>
                    </p>
                </div>
